...
const getResultByUserIdAndQuizId = function (userId, quizId) {
  return db
    .query(
      `
...
const updateScore = function (newScore, userId, quizId) {
  return db
    .query(
      `
...
module.exports = {
  getQuestionsCorrectAnswers,
  getUserProvidedAnswers,
